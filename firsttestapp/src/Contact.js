   ...
   const InputEvent = (event) => {
    ...
    return (
        <>
            ...
            <div className="container contact_div mb-sm-5">
                <div className="row">
...
<div class="mb-3">
  ...
  <input type="Phone" class="form-control" id="exampleFormControlInput1" name="phone" value={data.phone} onChange={InputEvent} placeholder="Mobile Number"/>
</div>
<div class="mb-3">
